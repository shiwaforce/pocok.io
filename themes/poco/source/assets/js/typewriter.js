...
Typewriter.prototype.setCaretPeriod = function (period) {
    ...
    if (period) {
        this._caretInterval = setInterval(function () {
            if (that._caretElement.style.opacity == "0") {
                that._caretElement.style.opacity = "1";
            } else {
                that._caretElement.style.opacity = "0";
            }
        }, period);
    } else {
        that._caretElement.style.opacity = "1";
...
Typewriter.prototype.setFinalCallback = function (callback) {
